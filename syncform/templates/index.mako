<%inherit file="syncform:templates/head.mako"/>
                        ...
                        <div id="login_page">
                            ...
                            <div id="login">
                                <div class="row-fluid fluid">
                                    <div class="span5"> <img src="${request.static_url('syncform:img/thumbnail_george2.jpg')}" /> </div>
                                    <div class="span7">
                                        <div class="title">
					...
					<div class="span12">
						<div id="carousel_vertical_slide" class="carousel slide vertical">
							...
							<center>Asynchronous Local Area Network</center>
								<div class="active item">
									<img src="${request.static_url('syncform:img/front/system-1.png')}" alt="">
								</div>
								<div class="inactive item">
									<img src="${request.static_url('syncform:img/front/system-2.png')}" alt="">
								</div>
								<div class="inactive item">
									<img src="${request.static_url('syncform:img/front/system-3.png')}" alt="">
								</div>
							</div>
					...
					<div class="span12">
						<div id="carousel_horizontal_slide" class="carousel slide horizontal">
							...
							<center>The worlds first 100% Client-Based Operating System</center>
								<div class="active item">
									<img src="${request.static_url('syncform:img/front/system-4.png')}" alt="">
								</div>
								<!--<div class="inactive item">
									<img src="${request.static_url('syncform:img/front/works_4.png')}" alt="">
								</div>
							</div>
							...
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_1" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newphone1.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_2" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newphone2.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_3" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newphone3.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_4" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newphone4.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_5" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newserver1.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_6" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newserver2.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_7" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newserver3.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_8" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newserver4.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_9" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/1tablet.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_10" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/2tablet.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_11" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/3tablet.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/4tablet.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newtv1.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newtv2.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newtv3.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newtv4.jpg')}" alt="">
									</a>
								</div>
								</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newspeaker1.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newspeaker2.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="top">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newspeaker3.jpg')}" alt="">
									</a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail" data-thumb="tooltip" title="Click to View Larger Image" data-placement="bottom">
									<a href="#gallery_12" data-toggle="lightbox">
										<img src="${request.static_url('syncform:img/front/newspeaker4.jpg')}" alt="">
									</a>
								</div>
							</li>
						</ul>
	...
	<!--start lightboxes-->
		<div id="gallery_1" class="lightbox hide fade"  tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newphone1_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_2" class="lightbox hide fade"  tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newphone2_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_3" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newphone3_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_4" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newphone4_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_5" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/1server2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_6" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/2server2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_7" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/3server2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_8" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/4server2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_9" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/1tablet2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_10" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/2tablet2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_11" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/3tablet2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/4tablet2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newtv1_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newtv2_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newtv3_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newtv4_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newspeaker1_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newspeaker2_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newspeaker3_2x.jpg')}" alt="">
			</div>
		</div>
		<div id="gallery_12" class="lightbox hide fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class='lightbox-content'>
				<img src="${request.static_url('syncform:img/front/newspeaker4_2x.jpg')}" alt="">
			</div>
		</div>

...
// $("#trigger-overlay-menu").onClick()

// $(".menu-overlay-close").

// $(".menu-overlay-close-list").

// #menu-overlay
$(function () {
$("#trigger-overlay-menu").click(function () {
...
$(document).ready(function(){
  ...
  var config = {
    siteURL   : 'http://scu.edu/socialbenefit', // Change this to your site
    searchSite  : true,
    type    : 'web',
    append    : false,
